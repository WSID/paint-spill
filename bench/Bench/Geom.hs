...
polygonToTriangles poly = fold ((N.toList . triangulateXMono) <$> monotoneDecompNonZero poly)
...
benchGeom = bgroup "Geom"
  ...
  , bgroup "Monotone Decomp"
      [ bench "Small" $ nf monotoneDecompNonZero polygonSmall
      , bench "Polygon 128" $ nf monotoneDecompNonZero polygon128
      , bench "Polygon 256" $ nf monotoneDecompNonZero polygon256
      , bench "Polygon 512" $ nf monotoneDecompNonZero polygon512
      , bench "Spike 128" $ nf monotoneDecompNonZero spike128
      , bench "Spike 256" $ nf monotoneDecompNonZero spike256
      , bench "Spike 512" $ nf monotoneDecompNonZero spike512
      ]
