...
testGroupPolygon = testGroup "Polygon"
  [ testGroup "Poly Elem"
      ...
      , testCase "Diamond Tower" $ do
            let poly =
                  [ [ V2 0 0, V2 4 0, V2 2 2]
                  , [ V2 0 4, V2 2 2, V2 4 4]
                  , [ V2 0 2, V2 2 4, V2 4 2, V2 2 0]
                  ]

            V2 1.0 0.5 `polyElemNonZero` poly @?= True
            V2 0.0 1.0 `polyElemNonZero` poly @?= False
            V2 2.0 1.0 `polyElemNonZero` poly @?= False
            V2 3.0 2.0 `polyElemNonZero` poly @?= True
      ]

  , testGroup "Monotone Decomposition"
      [ testCase "Triangle" $ do
            let poly = [V2 0 0, V2 1 0, V2 0 1]
                monos = monotoneDecompNonZero [zip [ 0 .. ] poly]
      ...
      , testCase "Holed Shape" $ do
            ...
            let monos = monotoneDecompNonZero polyL
      ...
      , testCase "Diamond Tower" $ do
            ...
            let polyL =
                  [ [ (0, V2 0 0), (1, V2 4 0), (2, V2 2 2) ]
                  , [ (3, V2 0 4), (2, V2 2 2), (4, V2 4 4) ]
                  , [ (5, V2 0 2), (6, V2 2 4), (7, V2 4 2), (8, V2 2 0) ]
                  ]
